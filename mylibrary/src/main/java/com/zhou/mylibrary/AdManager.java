...
public class AdManager {
    ...
    private com.uuch.adlibrary.AnimDialogUtils animDialogUtils;
    ...
    // 弹性动画弹性参数
    private double bounciness = com.uuch.adlibrary.AdConstant.BOUNCINESS;
    // 弹性动画速度参数
    private double speed = com.uuch.adlibrary.AdConstant.SPEED;
    // viewPager滑动动画效果
    ...
    public void showAdDialog(final int animType) {
        ...
        animDialogUtils = com.uuch.adlibrary.AnimDialogUtils.getInstance(context)
    ...
    public void dismissAdDialog() {
        animDialogUtils.dismiss(com.uuch.adlibrary.AdConstant.ANIM_STOP_DEFAULT);
    }
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setPadding(int padding) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setWidthPerHeight(float widthPerHeight) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setOnImageClickListener(OnImageClickListener onImageClickListener) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setAnimBackViewTransparent(boolean animBackViewTransparent) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setDialogCloseable(boolean dialogCloseable) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setOnCloseClickListener(View.OnClickListener onCloseClickListener) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setBackViewColor(int backViewColor) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setBounciness(double bounciness) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setSpeed(double speed) {
        this.speed = speed;
     ...
     */
    public com.uuch.adlibrary.AdManager setPageTransformer(ViewPager.PageTransformer pageTransformer) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AdManager setOverScreen(boolean overScreen) {
