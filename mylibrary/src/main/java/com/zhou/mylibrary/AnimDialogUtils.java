...
public class AnimDialogUtils {
    ...
    public static com.uuch.adlibrary.AnimDialogUtils getInstance(Activity context) {
        return new com.uuch.adlibrary.AnimDialogUtils(context);
    }
     ...
     * @return
     */
    public com.uuch.adlibrary.AnimDialogUtils initView(final View customView) {
        if (isOverScreen) {
        ...
        if (isDialogCloseable) {
            ...
            ivClose.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dismiss(com.uuch.adlibrary.AdConstant.ANIM_STOP_TRANSPARENT);
                }
            });
        } else {
     ...
     * @return
     */
    public com.uuch.adlibrary.AnimDialogUtils setDialogBackViewColor(int color) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AnimDialogUtils setDialogCloseable(boolean dialogCloseable) {
        isDialogCloseable = dialogCloseable;

        return this;
    }

    public com.uuch.adlibrary.AnimDialogUtils setOnCloseClickListener(View.OnClickListener onCloseClickListener) {
     ...
     * @return
     */
    public com.uuch.adlibrary.AnimDialogUtils setAnimBackViewTransparent(boolean animBackViewTransparent) {
     ...
     * @param overScreen
     */
    public com.uuch.adlibrary.AnimDialogUtils setOverScreen(boolean overScreen) {
